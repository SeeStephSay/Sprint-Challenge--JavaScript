...
for (let i = 0; i < universities.length; i++) {
	contactInfo.push(graduates[i].first_name + ' - ' + graduates[i].email); // Why is the [index] identifier necessary in this case? Why wouldn't it work without it?
}
...
const lowCaseAnimalNames = zooAnimals.map((animals) => animals.animal_name.toLowerCase());
