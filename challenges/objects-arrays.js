...
//     return unisWithUni.push(`${graduates.university}`);
//   }
// });

// console.log(unisWithUni);

// if (["uni"].indexOf(graduates) >= 0) {
//   unisWithUni();
// }
// console.log(unisWithUni);
...
// const populationTotal = people => Object.values(people).reduce((one, two) => one + two);
// console.log(population(populationTotal), 0);

// SECOND ATTEMPT
// function population(animal) {
//   return animal.reduce((sum, i) => sum + i.age, 0);
// }
